        ...
        return of(null).pipe(mergeMap(() => {
            ...
            if (request.url.endsWith('/users/authenticate') && request.method === 'POST') {
                ...
                let filteredUsers = users.filter(data => {
                    ...
                    console.log(data.user.username === request.body.username, data.user.password === request.body.password)
                    return data.user.username === request.body.username && data.user.password === request.body.password;
                });
